...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600"></div>
    );
  }
  ...
  return (
    <button
      ...
      className="rounded-full p-2 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-700"
